...
<template>
  <Card
    ref="targetRef"
    class="bg-gray-700 border border-gray-600 text-center transition-all opacity-0 translate-y-8 hover:-translate-y-2 hover:scale-105 hover:border-blue-500 hover:shadow-lg hover:shadow-blue-500/20"
